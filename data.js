...
const gameData = {
    locations: {
        "living_room": {
            ...
            "first_visit_description": "You wake up from your afternoon nap to find Maxwell behaving very strangely. The orange tabby is sitting perfectly still by the large window, his green eyes focused on... nothing you can see. But his ears are perked forward and his tail does that slow, meaningful twitch that says 'I know something important.' The living room feels charged with anticipation.",
            "exits": {
                "kitchen": "kitchen",
                "bedroom": "bedroom"
            },
            "actions": {
                "follow maxwell": "maxwell_leads_to_kitchen",
        ...
        "garden": {
            ...
            "actions": {
                ...
                "follow maxwell": "dig_behind_plants",
